...
class ColorUtils {
  ...
  /// measure of the difference in perceived brightness between two colors, and is
  /// an important factor in determining the accessibility and readability of text
  /// and other visual elements. This method calculates the contrast ratio using
  /// the relative luminance of the colors, which is a measure of their perceived
  /// brightness. The resulting contrast ratio is a scalar value that indicates
  /// how much the colors differ in brightness, with higher values indicating
  /// greater contrast. A contrast ratio of at least 4.5:1 is generally recommended
  /// for normal text, and a ratio of at least 7:1 is recommended for large text
  ...
  /// [opacity].
  static Color fromHSV(double hue,
      double saturation,
      double value, {
        double opacity = 1.0,
      }) {
  ...
  /// process of reducing the level of saturation in a color, which makes it appear
  /// less vivid or intense. This method calculates the new saturation level
  /// relative to the current level of saturation of the color, so a level of 0.5
  /// would reduce the saturation by half. The resulting color is based on the
  /// original hue and value of the color, and has the same opacity level as the
  /// original. This method can be useful for adjusting the color balance or
  /// saturation of images and visual elements in a more natural or intuitive way.
  ...
  /// resulting hue value. The saturation and value (brightness) of the resulting
  /// color are the same as the original color. The resulting color is similar to
  /// the [inverse] color of the given color, but with a slightly different shade
  /// and hue. This method can be useful for creating color schemes or palettes
  /// that have a high degree of contrast and visual impact, or for creating
  /// complementary color pairs for user interfaces and visual designs.
  ...
  /// scheme that uses four colors arranged into two complementary pairs that are
  /// equally spaced apart on the color wheel. The [angle1] and [angle2] parameters
  /// specify the amount of hue shift for the additional colors. The resulting
  /// color has a high degree of contrast and can be useful for creating color
  /// combinations that are visually balanced and harmonious.
  ...
  static List<Color> spectrum(int count, {
    double start = 0,
    double end = 360,
  }) {
  ...
  static List<Color> shades(Color color,
      int count, {
        double min = 0.0,
        double max = 1.0,
      }) {
