...
/// The base class for a display object that can contain child [GDisplayObject]s.
/// A display object container is a display object that can contain other
/// display objects as children. It renders its children in the order in which
/// they are added.
abstract class GDisplayObjectContainer extends GDisplayObject {
  ...
  /// [localPoint]. If [useShape] is set to true, the hit test will take the shape
  /// of the object into account. If [mouseChildren] is false, only the current
  /// display object will be tested.
...
//    if (child is DisplayObjectContainer) {}
  ...
  /// See also:
  ///
  /// * [swapChildrenAt], which swaps the positions of two children based on their
  /// indices instead of their references.
  ...
  /// Returns true if a given [child] is a descendant of this container, or false
  /// otherwise.
  ...
  /// Notifies all child objects of a removed container [child] that they have been removed
  /// from the stage. This method is used internally by the framework to broadcast
  /// removedFromStage events to all children recursively. It should not be called
  ...
  /// ensure that all the children of a container are notified when the container
  /// itself is added to the stage.
  ///
