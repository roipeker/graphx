...
- fixed dart analyzer problem `Name non-constant identifiers using lowerCamelCase`.
- replaced `http://roi-graphx-artificial-horizon.surge.sh/` to `https://roi-graphx-artificial-horizon.surge.sh/` for security
